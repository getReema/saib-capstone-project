...
public class TransactionService {
	...
	public Transaction getTransactionTransactionID(long transactionID) {
		...
		if (optional.isPresent()) {
			...
			throw new ResponseStatusException(HttpStatus.NOT_FOUND,
					"Account with Account Number:" + transactionID + "doesn't exist"); // throw error if it doesn't
																						// exist
		}
	...
	public String addTransaction(Transaction transaction) {
		String result = "";
		Transaction storedTransaction = transactionRepository.save(transaction); // using JPA method .save(), it will
